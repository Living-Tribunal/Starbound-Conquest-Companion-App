...
export default function ToggleAtributeButton({ type, index }) {
  ...
  const handleDonePress = (toggleIndex) => {
    setToggleDone((prevState) => {
      ...
      updatedToggleDoneStates[type][toggleIndex] = !updatedToggleDoneStates[type][toggleIndex];
  ...
  const handlePress = (toggleIndex) => {
    setToggleStates((prevState) => {
      ...
      updatedToggleStates[type][toggleIndex] = !updatedToggleStates[type][toggleIndex];
  ...
  const handleCapacityPress = (toggleIndex) => {
    setToggleCapacity((prevState) => {
      ...
      updatedCapacityToggleStates[type][toggleIndex] = !updatedCapacityToggleStates[type][toggleIndex];
