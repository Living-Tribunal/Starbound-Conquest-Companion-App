...
export default function Settings() {
  ...
  /*   useEffect(() => {
    ...
    console.log("userFactionColor:", userFactionColor);
    console.log("profile:", profile);
  }, [faction, userFactionColor, profile]); */
      ...
      const getUserData = async () => {
        try {
          ...
          if (docSnap.exists()) {
            ...
            //console.log("User in Profile Settings:", data.photoURL);
          }
        } catch (error) {
    ...
    <SafeAreaView style={[styles.mainContainer]}>
      <ScrollView keyboardShouldPersistTaps="never">
        <View style={styles.container}>
          ...
          >
            <ImagePicker profile={profile} factionColor={userFactionColor} />
            {!data.length ? (
              <View
                width="100%"
                style={{
            ...
            <View style={styles.heroModalContainerButtons}>
              <TouchableOpacity
                style={styles.button}
                onPress={checkForUsernamePhotoFaction}
              >
