const FactionAvatars ={
    ...
    "The Zyrrians": {
        image: require("../assets/images/avatars/zy.webp"),
        description: "The Zyrrians faction are a people deeply rooted in trade and commerce, known for their vast travels across the galaxy in pursuit of goods and opportunities. Once a peaceful and passive society, their way of life was forever altered when their homeland was destroyed by the Lionfolk. While they continue their trading traditions, their approach now carries a sharp edge. No longer willing to be exploited, the Zyrrians have adopted a philosophy of resilience and strength. They negotiate with skill and determination but remain prepared to fight if necessary. Against the Lionfolk, their resolve hardens into vengeance—they will battle with relentless fury, refusing to yield until the last warrior stands. To join the Zyrrians faction is to embrace the art of negotiation while always keeping a hand near the trigger, ready for action if a deal turns sour. Trust, respect, and strength now define their place in the galaxy.",
        ship:{
            Fighter: {
  ...
  "Voidborn Marauders" : {
    image: require("../assets/images/avatars/zm.webp"),
    ...
    "Star Reapers": {
        image: require("../assets/images/avatars/sr.webp"),
        description: "The Star Reapers faction is one of violence and death. They were famously founded by Kretor, “The Destroyer of Worlds.” He liberated an entire prison planet filled with a solar system's worst criminals and made them into a Starbound faction like none other. They are known to reap every ounce of material, recourses, and life from any they come across. The Star Reapers have so embodied total annihilation that in some cultures they have become the mythology of death itself. To be a Star Reaper is to be furiously loyal to your Faction, but everyone else are lambs for the slaughter. ",
        ship:{
            Fighter: {
    ...
    "The Union": {
        image: require("../assets/images/avatars/un.webp"),
